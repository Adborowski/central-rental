...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-168827144-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-168827144-1');
  gtag('config', 'AW-745944823'); // new 251221
</script>
...
})(window,document,'script','dataLayer','GTM-N7QV7MT');</script>
<!-- End Google Tag Manager -->

<!-- Event snippet for Przycisk Rezerwacja terminu conversion page In your html page, add the snippet and call gtag_report_conversion when someone clicks on the chosen link or button. --> 
<script> 
  function gtag_report_conversion(url) { var callback = function () { if (typeof(url) != 'undefined') { window.location = url; } }; gtag('event', 'conversion', { 'send_to': 'AW-745944823/ZAQDCOT36owCEPft2OMC', 'event_callback': callback }); return false; } 
</script>
...
<script src="https://client8134.idosell.com/widget/script/loadScriptsForOwnPage?1576501743"></script><script src="https://client8134.idosell.com/template/widget/js/widget_booking.js?1576501743"></script>
    ...
    <noscript>
        ...
        src="https://www.facebook.com/tr?id=2745637838783957&ev=PageView
        &noscript=1"/>
    </noscript>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-N7QV7MT"
...
<script
  ...
  data-auto-block="off"
  data-website-uuid="0d85a7c5-dea3-4e26-abb3-427c19fa8c61"
></script>